...
/*        case "todayButton":
            document.getElementById("today").addEventListener('click', function(){
                ...
                theOrganizer.setToday(currentDay);
            })
            break;*/
    }
};
...
var calendar = new Calendar("calendarContainer", "medium", [ "Sunday", 3 ], [ "#0a6aab", "#ddd", "#ffffff", "#666" ]);
...
/*organizer.setOnClickListener('todayButton', function(){showEvents(); console.log("today clicked");});*/

// function goToToday(){
//     console.log("today clicked");
//     currentDay = calendar.date.getDate();
//     this.changeDateTo(currentDay);
//     showEvents();
// }