<?php
	...
	$title = 'Mange Company '.$name;

	$text = '<table>
				<tr><td>Company Name:</td><td>'.$name.'</td></tr>
				<tr><td>Admin:</td><td><a href="/Profile?p='.encrypt($admin_personid).'">'.$admin_name.'</a></td></tr>
				<tr><td>Location:</td><td>'.$location.'</td></tr>
				<tr><td>Website:</td><td><a href="http://'.$domain.'">'.$domain.'</a></td></tr>
